    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Current performance of your selected stocks</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            <p className="text-muted-foreground">Loading portfolio...</p>
          ) : portfolio.length === 0 ? (
            <p className="text-muted-foreground">No stocks selected. Go to Edit Picks to select 10 stocks.</p>
          ) : (
